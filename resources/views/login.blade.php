...
<!-- Mirrored from template-honey-bee.mysapo.net/account/login by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 May 2024 16:40:59 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <meta name="keywords" content="Đăng nhập tài khoản, Template Honey Bee, template-honey-bee.mysapo.net" />
    ...
    <link rel="preload" as='style' type="text/css" href="befarm/bizweb.dktcdn.net/100/472/304/themes/887048/assets/account_oder_style.scssbee5.css?1684115584822">
    <link href="befarm/bizweb.dktcdn.net/100/472/304/themes/887048/assets/account_oder_style.scssbee5.css?1684115584822" rel="stylesheet" type="text/css" media="all" />
    <script src="befarm/bizweb.dktcdn.net/assets/themes_support/bizweb-api.js" type="text/javascript"></script>
    <script src="befarm/bizweb.dktcdn.net/assets/themes_support/common.js" type="text/javascript"></script>
    <script src="befarm/bizweb.dktcdn.net/assets/themes_support/customer.js" type="text/javascript"></script>
...
<body>
                            ...
                            <div class="navigation-head menu_mobile">
                                ...
                                <nav class="nav-horizontal">
                                    <div class="account_mb">
                                        ...
                                        <a href="login"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                                <path d="M224 256c70.7 0 128-57.31 128-128s-57.3-128-128-128C153.3 0 96 57.31 96 128S153.3 256 224 256zM274.7 304H173.3C77.61 304 0 381.6 0 477.3c0 19.14 15.52 34.67 34.66 34.67h378.7C432.5 512 448 496.5 448 477.3C448 381.6 370.4 304 274.7 304z" />
                                            </svg>Đăng nhập</a>
                                        <a href="register"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    ...
                                    <ul class="item_big">
                                        ...
                                        <li class="nav-item level0 ">
                                            <a class="a-img" href="../shop" title="Sản phẩm">
                                                Sản phẩm <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="caret-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="svg-inline--fa fa-caret-down fa-w-10">
                                            ...
                                            <ul class="item_small level0">
                                                <li class="level1">
                                                    <a href="../mat-ong-thien-nhien.html" title="Mật ong nhập khẩu">Mật
                                                        ong nhập khẩu</a>
                                                </li>
                                                <li class="level1">
                                                    ...
                                                    <ul class="level1">
                                                        <li class="level2">
                                                            <a href="../mat-ong-thien-nhien.html" title="Mật ong rừng nhiệt đới" class="a3">Mật ong rừng
                                                                nhiệt đới</a>
                                                        </li>
                                                        <li class="level2">
                                                ...
                                                <li class="level1">
                                                    <a href="../mat-ong-hoa.html" title="Mật ong nguyên chất">Mật ong
                                                        nguyên chất</a>
                                                </li>
                                            </ul>
                                        </li>
                    ...
                    <div class="col-lg-5 col-md-7 col-12">
                        <div class="header-right">
                            ...
                            <div class="account_header">
                                <a href="logina3b1.html" class="icon-cart">
                                    <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-user fa-w-14">
                            ...
                            <div class="header_search clearfix">
                                ...
                                <form action="https://template-honey-bee.mysapo.net/search" class="input-group search-bar theme-header-search-form ultimate-search" role="search">
                            ...
                            <div class="top-cart-contain">
                                <a class="img_hover_cart" href="../cart" title="Giỏ hàng">
                                    <svg class="icon">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#cartheader"></use>
                                    </svg>
                        ...
                        <div class="col-12 col-md-6 offset-md-3 col-lg-4 offset-lg-4">
                            ...
                            <div class="page-login">
                                <div id="login">
                                    ...
                                    <form method="post" action="login.blade.php" id="customer_login" accept-charset="UTF-8"><input name="FormType" type="hidden" value="customer_login" /><input name="utf8" type="hidden" value="true" />
                                        ...
                                        <div class="form-signup clearfix">
                                            ...
                                            <div class="pull-xs-left button_bottom a-center">
                                                ...
                                                <p style="font-size:14px;">Bạn chưa có tài khoản <a href="register.html" class="btn-link-style btn-register" style="text-decoration: underline; ">Đăng ký tại đây</a></p>
                                                <p style="font-size:14px;">Bạn quên mật khẩu <a href="#" class="btn-link-style" style="margin-right: 30px;" onclick="showRecoverPasswordForm();return false;">Lấy lại tại
                                                        đây</a></p>
                                            </div>
                                ...
                                <div id="recover-password" style="display:none;" class="form-signup page-login">
                                    ...
                                    <form method="post" action="https://template-honey-bee.mysapo.net/account/recover" id="recover_customer_password" accept-charset="UTF-8"><input name="FormType" type="hidden" value="recover_customer_password" /><input name="utf8" type="hidden" value="true" />
                                        ...
                                        <div class="action_bottom">
                                            <input class="btn btn-style btn-primary btn-recover btn_50" type="submit" value="Gửi" />
    ...
    <link rel="preload" href="befarm/bizweb.dktcdn.net/100/472/304/themes/887048/assets/js-customer-validatebee5.js?1684115584822" as="script">
    ...
    <link href="befarm/bizweb.dktcdn.net/100/472/304/themes/887048/assets/ajaxcart.scssbee5.css?1684115584822" rel="stylesheet" type="text/css" media="all" />
    ...
    <div class="hover_cart_fixed d-none d-lg-block">
...
<!-- Mirrored from template-honey-bee.mysapo.net/account/login by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 May 2024 16:41:00 GMT -->
